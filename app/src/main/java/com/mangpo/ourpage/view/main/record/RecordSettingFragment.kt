...
import com.mangpo.ourpage.databinding.FragmentRecordSettingBinding
...
import com.mangpo.ourpage.utils.ImgUtils.getAbsolutePathByBitmap
import com.mangpo.ourpage.utils.ImgUtils.uriToBitmap
import com.mangpo.ourpage.utils.isNetworkAvailable
import com.mangpo.ourpage.view.BaseFragment
import com.mangpo.ourpage.viewmodel.BookViewModel
...
class RecordSettingFragment : BaseFragment<FragmentRecordSettingBinding>(FragmentRecordSettingBinding::inflate) {
    ...
    override fun initAfterBinding() {
        if (args.mode=="CREATE" && ::recordVerCreate.isInitialized)
            ...
            Log.d("RecordSettingFragment", "recordVerCreate: $recordVerCreate")
    ...
    private fun observe() {
        ...
        postVm.updatePostCode.observe(viewLifecycleOwner, Observer {
            Log.d("RecordSettingFragment", "updatePostCode Observe! updatePostCode -> $it")
            dismissLoadingDialog()
